        ...
        <form onSubmit={handleSubmit} className=" p-6 rounded-lg flex flex-col ">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              required
            >
              <option value="" className='text-gray-700 font-medium text-left py-2 font-mono'>Select your Gender</option>
              <option value="guest" className='text-gray-700 font-medium text-left py-2 font-mono'>Male</option>
              <option value="admin" className='text-gray-700 font-medium text-left py-2 font-mono'>Female</option>
              <option value="hotel_owner" className='text-gray-700 font-medium text-left py-2 font-mono'>Other</option>
            </select>
          </div>
